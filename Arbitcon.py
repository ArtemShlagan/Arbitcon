...
logger = logging.getLogger('ArbitconCopyBot')

api_id = '23415626'
api_hash = '84407a767ffbbd9ce175bb9dba5948f2'

channel_pairs = [
    ('@traffic_ultras', -1002429220066),
    ('@free_traffs', -1002429220066),
    ('@nonamet9am', -1002429220066),
...
def remove_all_link_lines(message):
    ...
    if removed_any:
        inline_link = '<a href="https://t.me/+McRMKkrLxsc1ODAy">Arbitcon</a>'
        if new_text:
            new_text += "\n" + inline_link
        else:
